...
2. **Run the installer**  
   ...
   > <div align="center">
   > <strong>[Download QuantumDatToolSetup.exe](https://raw.githubusercontent.com/yuanxiuliang/Quantum-Design-DAT-Tool/main/releases/latest/QuantumDatToolSetup.exe)</strong>
   > </div>
